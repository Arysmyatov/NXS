...
{
    public class CommercialFuelConsumptionByTechnologyDescriptionVariableDescription  : XlsVariableDescriptionAbstract
    {
        ...
        public CommercialFuelConsumptionByTechnologyDescriptionVariableDescription()
        {
